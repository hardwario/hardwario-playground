    ...
    <div className="bg-white border border-gray-200 shadow-sm mt-4">
      ...
      {pairingMode && (
        <div className="px-4 py-3 bg-blue-50 border-b border-blue-200 flex items-center gap-3">
          ...
          <div>
            <p className="text-sm font-medium text-blue-800">{i18n.__('Pairing mode active')}</p>
            <p className="text-xs text-blue-600">{i18n.__('Press the button on your device to pair it')}</p>
          </div>
        </div>
      )}
